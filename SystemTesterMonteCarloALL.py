...
M_NS_min, M_NS_max= 1.44, 1.44
M_bind = 0.17
w_min, w_max= 0, 350
M1_min, M1_max= M_NS_max+M_bind+0.01, 5
M2_min, M2_max,M2_type,flatdist= 18, 18, 'MSS', True
ang_min, ang_max= 0, 90
p_orb_min, p_orb_max= 35, 80
...
e_min, e_max= 0, 0.12
p_orbf_min, p_orbf_max= 59.69-(59.69*0.03), 59.69+(59.69*0.03)
...
while N_viable < iterate:
    ...
    M2 = M2_min+(ang_max-ang)/(ang_max-ang_min)*(M2_max-M2_min)
    if flatdist:
    ...
    alpha_ej = (w/1000)/211*(0.1/((DeltaM-M_bind*sun_mass)/sun_mass))*((M_NS/sun_mass)/1.5)
